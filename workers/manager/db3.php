...
if($password != $password2){
	...
	header( "refresh:1; url=details.php");
	 ...
	 $sql2 = $con->query( "SELECT * FROM workers WHERE email ='$email'");
...
$sql ="INSERT INTO workers (username,lastname,email,contact,password) VALUES('$username','$lastname','$email','$contact','$encrypt')";
